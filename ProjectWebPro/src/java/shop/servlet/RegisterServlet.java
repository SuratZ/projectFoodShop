...
@PersistenceUnit(unitName = "projectWebProPU")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (emailRegis != null && passwordRegis != null) {
            ...
            try {
                ...
                String from = "Krittaporn.bn@gmail.com";
                String to = request.getParameter("email");
                String subject = "Activate Account";
                String message = "If your run on localhost Click this link," + " http://localhost:8080/projectWebPro/Activate?email=" + account.getEmail() + "&activateKey=" + account.getActivateKey()
                        + "\n If you run with KMUTT-Secure Click this link," + " http://10.5.5.157:8080/projectWebPro/Activate?email=" + account.getEmail() + "&activateKey=" + account.getActivateKey()
                        + "\n If you run with eduroam Click this link," + " http://10.5.43.91:8080/projectWebPro/Activate?email=" + account.getEmail() + "&activateKey=" + account.getActivateKey();

                String login = "Krittaporn.bn@gmail.com";
                String password = "Krittaporn11";
                ...
                try {
                    ...
                    String sb = "<head>"
                            ...
                            + "</center><br><center><p> Your Account: "+account.getEmail()+"</p></center>"
                            
                            
                            + "<center>"
                            + "<a a href=\"http://localhost:8080/MyProjectWebApp/Activate?username="+account.getEmail()+"&activateKey="+account.getActivateKey()+"\">"
